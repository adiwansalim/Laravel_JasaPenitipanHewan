    ...
    <section class="home-section">
        ...
        <div class="home-content">
            ...
            <div class="form-login">
                <form action="/updatedata1/{{$hewan->id_hewan}}" method="POST">
                    @csrf
                    <label for="nama">Nama Hewan</label>
                    <input class="input" type="text" name="nama" value="{{$hewan->nama}}" id="nama_hewan" placeholder="Nama Hewan" />
                    <label for="jenis">Jenis Hewan</label>
                    <input class="input" type="text" name="jenis" value="{{$hewan->jenis}}" id="biaya_penitipan" placeholder="Jenis Hewan" />
