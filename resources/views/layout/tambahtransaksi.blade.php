	...
	<div class="container">
		...
		<main>
			...
			<div class="cards-categories">
				<h2>Transaksi Hewan</h2>
				<div class="card-categories">
<form action="/insertdata2" method="post">
            @csrf
  <div class="form-group">
    <label for="exampleInputEmail1">Nama Hewan</label>
    <select name="id_hewan" id="">
    <option value="">Pilih Hewan</option>
    @foreach ($hewan as $d)
    <option value="{{$d->id_hewan}}">{{$d->nama}}</option>
    @endforeach
   </select>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">ID Transaksi</label>
    <input type="text" name="id_transaksi" class="form-control" id="exampleInputPassword1" placeholder="ID kamar" value="">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Harga</label>
    <input type="text" name="harga" class="form-control" id="exampleInputPassword1" placeholder="Harga" value="">
  </div>
