        ...
        <div class="home-content">
            ...
            <div class="form-login">
                <form action="/insertdata1" method="POST">
                    ...
                    <input class="input" type="text" name="nama" id="nama_hewan" placeholder="Nama Hewan" />
                    <label for="jenis">Jenis Hewan</label>
                    <input class="input" type="text" name="jenis" id="biaya_penitipan" placeholder="Jenis Hewan" />
